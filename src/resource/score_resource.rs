...
#[post("/score/<task_id>")]
pub fn score<'a>(session: Session, task_id: u32, repository: &'a State<LegacyRepository>) -> Result<Json<u16>, NotFound<String>> {
...
#[get("/score/<user_id>")]
pub fn get_score_of_user<'a>(user_id: u32, repository: &'a State<LegacyRepository>) -> Option<Json<Vec<Score>>> {

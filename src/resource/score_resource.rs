...
#[post("/score/<task_id>")]
pub async fn score<'a>(session: Session, task_id: u32, repository: &'a State<Neo4JRepository>) -> Result<Json<u16>, NotFound<String>> {
...
#[get("/score/<user_id>")]
pub async fn get_score_of_user<'a>(user_id: u32, repository: &'a State<Neo4JRepository>) -> Option<Json<Vec<Score>>> {

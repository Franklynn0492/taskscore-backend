...
#[post("/session/login")]
pub async fn login<'a>(login_request: LoginRequest<'a>, repository: &'a State<Neo4JRepository>, jar: &'a CookieJar<'_>) -> Result<Json<Session>, NotFound<String>> {
...
pub async fn logout<'a>(session: Session, repository: &'a State<Neo4JRepository>) -> Result<Json<()>, NotFound<String>> {

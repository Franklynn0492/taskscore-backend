...
#[post("/session/login")]
pub fn login<'a>(login_request: LoginRequest, repository: &'a State<Neo4JRepository>, jar: &'a CookieJar<'_>) -> Result<Json<Session>, NotFound<String>> {
...
pub fn logout<'a>(session: Session, repository: &'a State<Neo4JRepository>) -> Result<Json<()>, NotFound<String>> {
